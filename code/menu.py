...
from code.constantes import WIN_WIDTH, COR_VERMELHO, MENU_OPTION, COR_BRANCO


class Menu:
    def __init__(self, window):
        self.window = window
        self.surf = pygame.image.load('./asset/menu_lvl_1.png')  # Carrega a imagem (mas não coloca ela em lugar nenhum ainda)
    ...
    def run(self, ):
        ...
        while True:
            ...
            for i in range(len(MENU_OPTION)):
                self.menu_text(20, MENU_OPTION[i], COR_BRANCO, ((WIN_WIDTH / 2),  300+30*i))
